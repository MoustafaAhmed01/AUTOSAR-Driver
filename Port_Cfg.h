...
#define PORT_CONFIGURED_CHANNLES              (43U) /* We can config only 39 pin excluding JTAG pins */
...
#define PORT_PIN_MODE_CORE		          (12U)  /*TRD0,TRD!,TRCLK*/ 
...
#define PORT_PIN_DEFAULT_INITIAL_VALUE             (PORT_PIN_LEVEL_LOW)               
